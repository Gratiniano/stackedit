...
### Role playing, Enfoque y Cooperación
...
- **Role playing**: se ha asignado un rol a cada agente.
- **Enfoque**: a través del prompt se ha indicado a cada agente cual es su tarea.
- **Cooperación**:El agente de QA puede delegar trabajo al agente de soporte.
